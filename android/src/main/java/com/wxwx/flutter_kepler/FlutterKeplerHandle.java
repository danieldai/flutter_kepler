...
//            dialog.setCanceledOnTouchOutside(false);
    ...
    public static FlutterKeplerHandle getInstance(){
        if (handle == null){
    ...
    public void openJDUrlPage(MethodCall call, Result result){
        ...
        try {
            ...
            mKelperTask= KeplerApiManager.getWebViewService().openJDUrlPage(url, customerInfo, activity, mOpenAppAction,TIMEOUT);
